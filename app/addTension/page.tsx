    ...
    return (
        <div className="p-4 max-w-xl mx-auto space-y-6">
            <div className="flex justify-between items-center mt-8">
                ...
                <Button variant="outline" size="sm" onClick={() => supabase.auth.signOut().then(() => router.push("/login"))}>
                    Çıkış
                </Button>
            </div>
            ...
            <Card className={editingId ? "border-blue-500 ring-1 ring-blue-500" : ""}>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Button
                            className={`w-full ${editingId ? "bg-blue-600 hover:bg-blue-700" : "bg-red-600 hover:bg-red-700"}`}
                            type="submit"
                            disabled={loading}
                        >
            ...
            <div className="flex gap-2">
                ...
                <Button variant="secondary" className="flex-1" onClick={handleDOC}>
